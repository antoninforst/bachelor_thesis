...
\usepackage[natbib,style=authoryear,language=english, autolang=none]{biblatex}
%
...
\DeclareLanguageMapping{sanskrit}{english}
...
%\setmonofont{Latin Modern Mono}[RawFeature={fallback=monofallback}]
