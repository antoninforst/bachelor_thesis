...
Usage:
    python src/0_data_processing/corpora/bible/get_bible.py
    python src/0_data_processing/corpora/bible/get_bible.py --dry-run
"""
...
SHORTCUTS_CSV = Path("src/0_data_processing/corpora/leipzig/lepzig_shortcuts.csv")
