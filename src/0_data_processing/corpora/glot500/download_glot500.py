...
Usage:
    python src/0_data_processing/corpora/glot500/download_glot500.py
    python src/0_data_processing/corpora/glot500/download_glot500.py --langs alt chv krc
    python src/0_data_processing/corpora/glot500/download_glot500.py --skip-existing
    python src/0_data_processing/corpora/glot500/download_glot500.py --list-configs
"""
