...
Usage:
    python src/0_data_processing/language_overview.py
"""
...
STATISTICS_CSV = Path("results/0_data_processing/statistics.csv")
SCRIPT_CHECK_CSV = Path("results/0_data_processing/script_check.csv")
LANG_FAMILIES_CSV = Path("data/5_other/lang_families.csv")
LEIPZIG_SHORTCUTS_CSV = Path("src/0_data_processing/corpora/leipzig/lepzig_shortcuts.csv")
UD_MAPPING_CSV = Path("src/0_data_processing/corpora/ud/ud_language_mapping.csv")
OUTPUT_CSV = Path("results/0_data_processing/language_overview.csv")
